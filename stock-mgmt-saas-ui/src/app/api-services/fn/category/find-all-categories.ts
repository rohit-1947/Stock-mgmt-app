...
export function findAllCategories(http: HttpClient, rootUrl: string, params?: FindAllCategories$Params, context?: HttpContext): Observable<StrictHttpResponse<PageResponseCategoryResponse>> {
...
findAllCategories.PATH = '/api/v1/categories';
